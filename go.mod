module github.com/thenoetrevino/paso
...
require (
	charm.land/huh/v2 v2.0.0-20251118172832-2c1322d36358 // indirect
...
replace charm.land/lipgloss/v2 => github.com/charmbracelet/lipgloss/v2 v2.0.0-beta.3.0.20251119143523-0334bb4562ca
