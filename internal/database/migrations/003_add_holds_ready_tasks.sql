...
-- This boolean indicates if tasks in this column
-- are considered "ready" for work
-- Only one column per project can have holds_ready_tasks = true
...
-- Step 2: Create a unique partial index to ensure only one column per
-- project can be marked as ready
