...
func TestCreateAssignee_Errors(t *testing.T) {
	t.Parallel()
...
func TestListAssignees_Populated(t *testing.T) {
	...
	fixtures.CreateTestAssignee(t, db, fixtures.SQLiteDialect(), "alice")
	fixtures.CreateTestAssignee(t, db, fixtures.SQLiteDialect(), "bob")
	fixtures.CreateTestAssignee(t, db, fixtures.SQLiteDialect(), "charlie")
...
func TestDeleteAssignee(t *testing.T) {
	t.Parallel()
	db, app := cli.SetupCLITest(t)
...
func TestDeleteAssignee_Errors(t *testing.T) {
	t.Parallel()
	_, app := cli.SetupCLITest(t)
